...
namespace vr
{
	...
	static const char * const IVROverlay_Version = "FnTable:IVROverlay_025";
...
struct VR_IVRDriverManager_FnTable
{
	...
	bool (__stdcall *IsEnabled)( vr::DriverId_t nDriver );
};
...
public:
	uint32_t GetDriverCount() { return _table.GetDriverCount(); }
	...
	bool IsEnabled( vr::DriverId_t nDriver ) { return _table.IsEnabled(nDriver); }
};
