...
*/
#ifndef GLNEMOGLGRIDOBJECT2_H
#define GLNEMOGLGRIDOBJECT2_H
...
class GLGridObject2: public GLObject {
public:

  GLGridObject2(int nsquare=50, float square_size=1.0, int axe=0,const QColor &c=Qt::yellow, bool activated=true)
          : m_nsquare(nsquare)
