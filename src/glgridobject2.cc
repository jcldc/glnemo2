...
using namespace std;
// ============================================================================
void GLGridObject2::setColor(const QColor& color) { 
  setVec4FromQColor(m_color, color);
}
// -- rebuild

void GLGridObject2::rebuild(int nsquare, float square_size)
{
  m_nsquare    = nsquare;
...
void GLGridObject2::draw(GLuint shaderProgram,
          ...
          const glm::mat4& projection) const
{
  ...
  void GLGridObject2::destroy()
  {
    ...
    if (!ctx) {
        ...
        qWarning("GLGridObject2::destroy() appelé sans contexte OpenGL actif !");
        m_vao = 0;
        m_vbo = 0;
        m_vertexCount = 0;
        return;
  ...
  GLGridObject2::~GLGridObject2() { destroy(); }
