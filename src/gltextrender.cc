...
GLTextRender::GLTextRender(bool activated):GLObject() {
...
bool GLTextRender::init(const std::string& fontPath, unsigned int pixelSize) {
  
  m_fontpath = fontPath;
  m_pixelsize = pixelSize;
  
  // first, destroy previous configuration if exist
  destroy();
...
void GLTextRender::draw(const std::string& text,
          float x, float y,
          float scale,
...
glnemo::TextBoundingBox GLTextRender::getTextBoundingBox(const std::string& text, 
                                                          float x, float y, 
                                                          float scale) {
