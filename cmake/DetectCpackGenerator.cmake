# -*-cmake-*-
# ============================================================================
# Copyright Jean-Charles LAMBERT - 2008-2020
...
if(UNIX)
  if(CMAKE_SYSTEM_NAME MATCHES "Linux")
    ...
    if(EXISTS "/etc/os-release")
      file(READ "/etc/os-release" LINUX_RELEASE)
    ...
    # Ubuntu case
    if(LINUX_RELEASE MATCHES "Ubuntu")
      set (CPACK_DEBIAN_PACKAGE_SHLIBDEPS ON) 
      set(MY_OS "Ubuntu")
      string(REGEX MATCH "([0-9]+\\.[0-9]+)" UBUNTU "${LINUX_RELEASE}")
      set(LINUX_NAME "ubuntu${CMAKE_MATCH_1}")        
      set(SPECIFIC_SYSTEM_PREFERED_CPACK_GENERATOR "DEB")
    endif(LINUX_RELEASE MATCHES "Ubuntu")
    # Mint case
    ...
    # Open SuSE case
    if(LINUX_RELEASE MATCHES "Leap")
      set(MY_OS "OpenSUSE LEAP")
      string(REGEX MATCH "VERSION=\"([0-9]+\\.[0-9]+)\"" SUSE "${LINUX_RELEASE}")
      ...
      string(REPLACE "/" "_" LINUX_NAME ${LINUX_NAME})   
      set(SPECIFIC_SYSTEM_PREFERED_CPACK_GENERATOR "RPM")     
    elseif (LINUX_RELEASE MATCHES "SUSE")
      set(MY_OS "Suse")
      string(REGEX MATCH "SUSE ([a-zA-Z]*/?[a-zA-Z]*) ([0-9]+\\.[0-9]+)" SUSE "${LINUX_RELEASE}")
      if (NOT ${CMAKE_MATCH_2} STREQUAL "")
        set(LINUX_NAME "opensuse-tumbleweed${CMAKE_MATCH_2}")
      else()
        set(LINUX_NAME "opensuse-tumbleweed${CMAKE_MATCH_1}")
      endif()
      string(REPLACE "/" "_" LINUX_NAME ${LINUX_NAME})
      set(SPECIFIC_SYSTEM_PREFERED_CPACK_GENERATOR "RPM")
    endif()
