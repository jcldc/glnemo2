...
#
# A collection of CMake utility functions useful for deploying Qt6
# executables.
#
...
#
# Requires CMake 2.8.9 or greater because Qt 6 does.
...
# fixes up a Qt6 executable using BundleUtilities so it is standalone
...
# and plugin installation.  See documentation of FIXUP_QT6_BUNDLE.
...
function(install_qt6_executable executable)
  ...
  if(QT_IS_STATIC)
    ...
    if(APPLE)
      get_property(loc TARGET Qt6::QCocoaIntegrationPlugin
        PROPERTY LOCATION_RELEASE)
      install_qt6_plugin("${loc}" "${executable}" 0 installed_plugin_paths
        "PlugIns" "${component}")
      list(APPEND libs ${installed_plugin_paths})
    elseif(WIN32)
      get_property(loc TARGET Qt6::QWindowsIntegrationPlugin
        PROPERTY LOCATION_RELEASE)
      install_qt6_plugin("${loc}" "${executable}" 0 installed_plugin_paths
        "" "${component}")
      list(APPEND libs ${installed_plugin_paths})
